...
class CrossAttention(nn.Module):
    ...
    def forward(self, x1, corr, camera=None, intrinsics=None):
        B, N, C = x1.shape
...
class CrossBlock(nn.Module):
    ...
    def forward(self, x, camera=None, corr = None,intrinsics=None):
        ...
        if not self.noess:
            ...
            fundamental1, fundamental2 = self.cross_attn(self.norm1(x1_in), corr,camera, intrinsics=intrinsics)
            fundamental_inter = fundamental1.unsqueeze(1)
