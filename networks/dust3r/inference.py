...
import tqdm
import torch
from networks.dust3r.utils.device import to_cpu, collate_with_cat
from networks.dust3r.utils.misc import invalid_to_nans
from networks.dust3r.utils.geometry import depthmap_to_pts3d, geotrf
...
def loss_of_one_batch(batch, model, criterion, device, symmetrize_batch=False, use_amp=False, ret=None):
    ...
    if symmetrize_batch:    # false
        view1, view2 = make_batch_symmetric(batch)

    with torch.cuda.amp.autocast(enabled=bool(use_amp)):
        pred1, pred2 = model['depth'](view1, view2)     # model -> model['depth']
