...
class Masked_DPT_Multiframe_Croco_Try4(nn.Module):
    def __init__(
        self,
        *,
        encoder,
        ...
        # cmap linear 
        self.cmap1_linear = nn.Linear(5760, 768)    # (head*n, d) = (12*480, 768)
        self.cmap2_linear = nn.Linear(5760, 768)
        self.cmap3_linear = nn.Linear(5760, 768)
        self.cmap4_linear = nn.Linear(5760, 768)
