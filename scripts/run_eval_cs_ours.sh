...
EVAL_ARGS="
    --eval
    --ckpt_name cs_ours
    --ckpt_path /media/dataset1/jinlovespho/aaai_log/pho_server5_gpu0_CITYSCAPES_croco_basebase_attnaggtest_zero05_topk_tf_lr5e6_fix_res192_512_mskSameMed/weights_10
    --batch_size 16
    --num_workers 4
    --seed 41
"
